...
#ifndef SUBPOPULATION_FRAMEWORK
#define SUBPOPULATION_FRAMEWORK
...
class Subpopulation_Framework: public Optimization_Method
{
	public:
		Subpopulation_Framework(int max_generations, int population_size, int subpopulation_size, double max_limit, double min_limit, float F, float CR, Random* random);
		~Subpopulation_Framework();
